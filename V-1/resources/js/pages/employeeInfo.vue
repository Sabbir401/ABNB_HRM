    ...
    <div class="row mb-3">
      <div class="col-lg-4 col-md-6 col-sm-12">
        ...
        <select name="" id="" class="form-control">
          ...
          <option value="">Artisan Business Network Bangladesh</option>
        </select>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        ...
        <select name="" id="" class="form-control">
          ...
          <option value="A-VE">Hindu</option>
          <option value="B+VE">Christian</option>
          <option value="B-VE">Others</option>
        </select>
      </div>
    </div>
